...
class AdvancedAnalytics: 
    ...
    def calculate_comprehensive_metrics(self,
        ...
        try: 
            ...
            # Drawdown analysis
            max_drawdown = self._calculate_max_drawdown(portfolio_values or self._returns_to_values(returns))
            ...
            ulcer_index = self._calculate_ulcer_index(portfolio_values or self._returns_to_values(returns))
    ...
    def analyze_drawdown_periods(self,
                                ...
                                dates: Optional[List[datetime]] = None)->List[DrawdownPeriod]:
        """
    ...
    def _calculate_calmar_ratio(self, returns: np.ndarray, portfolio_values: Optional[np.ndarray])->float:
    ...
    def _calculate_relative_metrics(self, returns: np.ndarray,
                                   benchmark_returns: Optional[np.ndarray])->Tuple[float, float, float, float, float]: 
