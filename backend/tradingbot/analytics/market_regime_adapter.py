...
from ..market_regime import MarketRegime, SignalGenerator, TechnicalIndicators, create_sample_indicators
...
class MarketRegimeAdapter:
    ...
    async def generate_strategy_adaptation(self,
                                         market_data: Dict[str, Any],
                                         current_positions: Optional[Dict[str, Any]] = None) -> StrategyAdaptation:
        """
    ...
    def _extract_indicators(self, market_data: Dict[str, Any]) -> Optional[TechnicalIndicators]:
    ...
    def _calculate_parameter_adjustments(self, regime: MarketRegime, market_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _calculate_timing_adjustments(self, regime: MarketRegime, market_data: Dict[str, Any]) -> tuple[int, float]:
...
async def adapt_strategies_to_market(market_data: Dict[str, Any],
                                   current_positions: Optional[Dict[str, Any]] = None,
                                   config: Optional[RegimeAdaptationConfig] = None) -> StrategyAdaptation:
    """
