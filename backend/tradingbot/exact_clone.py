...
try:
    ...
    class BlackScholesCalculator:
        ...
        def call_price(spot, strike, time_to_expiry_years, risk_free_rate, dividend_yield, implied_volatility):
            ...
            call_value = (spot*math.exp(-dividend_yield*time_to_expiry_years)*BlackScholesCalculator._norm_cdf(d1) - 
...
class DipType(Enum):
    ...
    INTRADAY_SELLOFF = "selloff"    # Selling pressure during session
