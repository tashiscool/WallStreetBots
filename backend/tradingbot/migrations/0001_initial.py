    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="tradingbot.company"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.DecimalField(decimal_places=2, help_text="quantity", max_digits=8),
                ),
                (
                    "portfolio",
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        to="tradingbot.portfolio",
                    ),
                ),
                (
                    "stock",
                    models.ForeignKey(
                        help_text="Associated stock",
                        on_delete=django.db.models.deletion.CASCADE,
                        to="tradingbot.stock",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price",
                    models.DecimalField(
                        decimal_places=2, help_text="order price", max_digits=8, null=True
                    ),
                ),
                (
                    "quantity",
