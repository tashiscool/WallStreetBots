...
def auto_exercise_likely(
    oc: OptionContract, u: UnderlyingState, threshold: float = 0.01
) -> bool:
    """Simple OCC auto-exercise heuristic: >= $0.01 ITM at expiration."""
    if dt.date.today() != oc.expiry:
        return False
...
def early_assignment_risk(
    oc: OptionContract, u: UnderlyingState, r_annual=0.03
) -> bool:
    """
