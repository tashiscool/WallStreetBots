...
class Phase2StrategyManager:
    ...
    async def start_strategy(self, strategy_name: str) -> bool:
        ...
        try:
            ...
            self.error_handler.handle_error(
                e, {"strategy": strategy_name, "operation": "start_strategy"}
            )
            return False
    ...
    async def stop_strategy(self, strategy_name: str) -> bool:
        ...
        try:
            ...
            self.error_handler.handle_error(
                e, {"strategy": strategy_name, "operation": "stop_strategy"}
            )
            return False
        ...
        try:
            ...
            if self.wheel_strategy:
                ...
                if candidates:
                    ...
                    self.logger.info(
                        f"Top wheel candidate: {top_candidate.ticker}",
            ...
            if self.debit_spreads:
                ...
                if candidates:
                    top_candidate = candidates[0]
                    self.logger.info(
                        f"Top debit spread: {top_candidate.ticker}",
