...
class EarningsProtectionScanner:
        ...
        for earning in mock_earnings:
            if earning["days_out"] <= days_ahead:
                ...
                try:
                    ...
                    expected_move, iv_current = self.estimate_earnings_move(
                        ticker, earning["days_out"]
                    )
    ...
    def create_protective_hedge_strategy(
        ...
        try:
            ...
            strategy = EarningsProtectionStrategy(
                ...
                breakeven_points=[
                    call_strike_actual + total_premium,
                    put_strike_actual - total_premium,
                ],
    ...
    def scan_earnings_protection(self) -> list[EarningsProtectionStrategy]:
        ...
        for event in events:
            ...
            print(
                f"   Current: ${event.current_price:.2f}, Expected move: ±{event.expected_move:.1%}"
            )
...
def main():
    ...
    if args.output == "json":
        print(json.dumps([asdict(s) for s in strategies], indent=2, default=str))
    else:
