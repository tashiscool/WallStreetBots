...
from ...production.data.production_data_integration import EarningsEvent
...
class ProductionEarningsProtection:
    ...
    def __init__(
        ...
        self.preferred_strategies = config.get(
            ...
            for event in earnings_events:
                try:
                    ...
                    if signal:
                        ...
                        self.logger.info(
                            f"Earnings signal detected for {signal.ticker}: "
    ...
    async def _analyze_earnings_opportunity(
        ...
        try:
            ...
            if (
                days_to_earnings < self.min_days_to_earnings
                or days_to_earnings > self.max_days_to_earnings
            ):
                return None
...
# Factory function
def create_production_earnings_protection(
    integration_manager: ProductionIntegrationManager,
    data_provider: ProductionDataProvider,
    config: dict[str, Any],
