...
class WheelPosition: 
    ...
    strike: Optional[int]  # For options
...
class WheelStrategy: 
    ...
    def find_optimal_strikes(self, ticker: str, current_price: float, 
