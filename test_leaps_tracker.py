...
from leaps_  # noqa: E402  # noqa: E402tracker import (  # noqa: E402
...
class TestEnhancedLEAPSScanning(unittest.TestCase):
    ...
    def test_risk_factor_enhancement(self):
        ...
        if death_cross_signal.cross_type == "death_cross" and death_cross_signal.days_since_cross < 30:
...
class TestLEAPSDisplayEnhancements(unittest.TestCase):
    ...
    def test_timing_indicators(self):
        ...
        timing_icon = "🟢" if excellent_timing_score > 70 else "🟡" if excellent_timing_score > 50 else "🔴"
        self.assertEqual(timing_icon, "🟢")
        
        # Moderate timing
        moderate_timing_score = 60.0
        timing_icon = "🟢" if moderate_timing_score > 70 else "🟡" if moderate_timing_score > 50 else "🔴"
        self.assertEqual(timing_icon, "🟡")
