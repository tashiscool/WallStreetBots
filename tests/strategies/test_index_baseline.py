...
class TestIndexBaselineScanner(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_vti_data = pd.DataFrame({"Close": vti_prices}, index=dates)
    ...
    def test_trading_cost_calculation(self):
        ...
        low_freq_cost = self.scanner.calculate_trading_costs(
            total_trades=20, avg_position_size=10000
        )
...
def run_index_baseline_tests():
    ...
    # Add test classes
    test_classes = [TestIndexBaselineScanner]
